...
const rgblight_segment_t PROGMEM en_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(3, HSV_BLUE),
    SPLIT_LED_MIRROR(5, HSV_BLUE)
);

const rgblight_segment_t PROGMEM ru_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(3, HSV_RED),
    SPLIT_LED_MIRROR(5, HSV_RED)
);

const rgblight_segment_t PROGMEM sym_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(0, HSV_GOLDENROD),
    SPLIT_LED_MIRROR(1, HSV_GOLDENROD)
);

const rgblight_segment_t PROGMEM nav_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(0, HSV_GREEN),
    SPLIT_LED_MIRROR(1, HSV_GREEN)
);

const rgblight_segment_t PROGMEM fn_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_RIGHT(1, HSV_PURPLE),
    SPLIT_LED_RIGHT(3, HSV_PURPLE),
    SPLIT_LED_RIGHT(5, HSV_PURPLE)
);

const rgblight_segment_t PROGMEM win_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_LEFT(1, HSV_AZURE),
    SPLIT_LED_LEFT(3, HSV_AZURE),
    SPLIT_LED_LEFT(5, HSV_AZURE)
);

const rgblight_segment_t PROGMEM game_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(0, HSV_RED),
    SPLIT_LED_MIRROR(1, HSV_RED),
    SPLIT_LED_MIRROR(2, HSV_MAGENTA),
    SPLIT_LED_MIRROR(3, HSV_MAGENTA),
    SPLIT_LED_MIRROR(4, HSV_RED),
    SPLIT_LED_MIRROR(5, HSV_RED)
);

const rgblight_segment_t PROGMEM mda_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_RIGHT(0, HSV_PINK),
    SPLIT_LED_RIGHT(2, HSV_PINK),
    SPLIT_LED_RIGHT(4, HSV_PINK)
);

const rgblight_segment_t PROGMEM debug_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(0, HSV_WHITE),
    SPLIT_LED_MIRROR(1, HSV_WHITE),
    SPLIT_LED_MIRROR(2, HSV_WHITE),
    SPLIT_LED_MIRROR(3, HSV_WHITE),
    SPLIT_LED_MIRROR(4, HSV_WHITE),
    SPLIT_LED_MIRROR(5, HSV_WHITE)
);
...
const rgblight_segment_t PROGMEM reset_rgb_layer[] = RGBLIGHT_LAYER_SEGMENTS(
    SPLIT_LED_MIRROR(0, HSV_BLUE),
    SPLIT_LED_MIRROR(1, HSV_BLUE),
    SPLIT_LED_MIRROR(2, HSV_BLUE),
    SPLIT_LED_MIRROR(3, HSV_BLUE),
    SPLIT_LED_MIRROR(4, HSV_BLUE),
    SPLIT_LED_MIRROR(5, HSV_BLUE)
);
